...
export class KaTableProgressbar {
  ...
  bind(bindingContext) {
    ...
    this.interface.events.addEventListener('load', () => { this.element.classList.add('visible'); });
    this.interface.events.addEventListener('loadSuccess', () => { this.element.classList.remove('visible'); });
    this.interface.events.addEventListener('loadFailure', () => { this.element.classList.remove('visible'); });
  }
}
