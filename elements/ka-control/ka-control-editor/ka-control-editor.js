...
export class KaControlEditor {
  ...
  buildEditor() {
    ...
    let config = {
      ...
      toolbar: {
        items: ['heading', '|', 'bold', 'italic', 'strikethrough', 'superscript', 'subscript', 'removeFormat', '|', 'bulletedList', 'numberedList', '|', 'alignment', 'indent', 'outdent', '|', 'code', 'codeBlock', '|', 'link', 'blockQuote', 'insertTable', 'imageInsert', 'mediaEmbed', 'htmlEmbed', '|', 'undo', 'redo', 'findAndReplace', '|', 'sourceEditing']
      },
      language: 'it',
      mediaEmbed: {},
      image: {
